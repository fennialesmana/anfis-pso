function fitness = get_fitness(premise, consequent, class, input_data, output_data)
%{
...
*) Input Parameter:
    ...
    - consequent = consequent parameter, size: (total features + 1)*class x 1
    - class   = total classes
...
output = H * consequent'; % calculate weight of hidden to output node
fitness = (sum((output_data - output).^2))/total_examples; % calculate error using MSE
